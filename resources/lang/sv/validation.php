...
return [
    ...
    */
    ...
    'max'                  => [
        'numeric' => 'Fältet får inte vara större än :max.',
        'file'    => ':attribute får max vara :max kilobyte stor.',
        'string'  => 'Fältet får max innehålla :max tecken.',
        'array'   => ':attribute får inte innehålla mer än :max objekt.',
    ],
    'mimes'                => ':attribute måste vara en fil av typen: :values.',
    'min'                  => [
        'numeric' => 'Fältet måste vara större än :min.',
    ...
    'unique_or_mine'       => ':attribute används redan.',
